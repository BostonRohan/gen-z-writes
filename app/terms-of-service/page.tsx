  ...
  return (
    <>
      <div className="text-slate-200 leading-10 opacity-70 p-4 max-w-4xl mx-auto scroll-mt-24">
        <h1 className="sm:text-5xl font-medium text-4xl">Terms of Service</h1>
        ...
        Terms and our Privacy Policy. If you do not agree to all of these Terms,
        you may not access or use the Service.
        <br />
        2. Access to the Service
        <br /> 2.1 Registration:
        <br /> To access certain features of the Service, you may be required to
        ...
        not to distribute, modify, transmit, or create derivative works based on
        any Content without our prior written consent. <br />
        ...
        <br /> e. Impersonate any person or entity or falsely state or otherwise
        ...
        granting you any license or right to use any trademark, logo, or service
        mark displayed on the Service without our prior written permission.{" "}
        <br />
        ...
        THE SERVICE OR CONTENT, INCLUDING, BUT NOT LIMITED TO, LOSS OF PROFITS,
        ...
        revision is material, we will provide notice prior to any new terms
        ...
        federal courts located in California, and you hereby consent to the
