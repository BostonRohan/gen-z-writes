      ...
      <div className="leading-10 p-4 max-w-4xl mx-auto scroll-mt-24">
        ...
        <div className="text-muted-foreground">
          <p>
            ...
            use the ProjectGenZWrites Writing Database (&quot;Service&quot;).{" "}
            ...
            collect certain information about your use of the Service, including
            your IP address, device information, browser type, and usage data.
            <br />
            ...
            b. Law enforcement or other government agencies in response to a
            legal request or if we believe disclosure is necessary to protect
            ...
            of all or a portion of our assets. <br />
            4. Data Security <br />
            ...
            or destruction. <br />
            5. Your Choices <br />
            5.1 You may access and update certain personal information by
            logging into your account settings. <br />
            ...
            contact us so that we can delete the information. <br />
            7. Changes to this Policy
            <br />
            7.1 We may update this Policy from time to time by posting the
            updated Policy on the Service. Your continued use of the Service
            after any changes to this Policy will constitute your acceptance of
            the changes. <br />
            8. Contact Us <br />
